...
import { UserPlus, AlertCircle, CheckCircle2 } from "@/components/icons";
...
export default function RegistroPage() {
  ...
  async function handleSubmit(e) {
    ...
    // Respaldo: si ya hay sesión activa (login inmediato, sin confirmación de correo),
    // aseguramos que el DNI y teléfono queden guardados aunque el trigger fallara.
